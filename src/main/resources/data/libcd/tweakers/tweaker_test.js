...
RecipeTweaker.addSmelting("minecraft:potion->minecraft:water", TweakerUtils.createItemStack("minecraft:dragon_breath"), 200, 0.35);

//create a recipe to blast a piece of coal -> a diamond. Takes 4x the fuel and time of a standard blasting operation.
RecipeTweaker.addBlasting("minecraft:coal", TweakerUtils.createItemStack("minecraft:diamond"), 400, 0.7);

//create a recipe to smoke a log -> a block of charcoal. Takes 4x the fuel and time of a standard smoking operation.
RecipeTweaker.addSmoking("#minecraft:logs", TweakerUtils.createItemStack("minecraft:coal_block"), 400, 0.7);

//create a recipe to bake an apple -> a golden apple on a campfire.
RecipeTweaker.addCampfire("minecraft:apple", TweakerUtils.createItemStack("minecraft:golden_apple"), 600, 0.7);
...
for (var i = 0; i < logs.length; i++) {
    RecipeTweaker.addStonecutting("#minecraft:logs", TweakerUtils.createItemStack(logs[i]));
}